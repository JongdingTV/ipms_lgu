...
CREATE TABLE IF NOT EXISTS project_proposals (
    ...
    ai_estimated_budget DECIMAL(15,2) NULL,
    ai_budget_low DECIMAL(15,2) NULL,
    ai_budget_high DECIMAL(15,2) NULL,
    ai_budget_confidence DECIMAL(5,2) NULL,
    ai_budget_rationale TEXT NULL,
    ai_budget_breakdown LONGTEXT NULL,
    ai_budget_generated_at DATETIME NULL,
