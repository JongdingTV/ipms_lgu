...
$extraStylesheets = ['assets/css/pagination.css', 'assets/css/project-timeline.css', 'bac/assets/css/bac.css'];
      ...
      <section class="lower-row reveal">
        <article class="info-card">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
            ...
            <button class="btn-secondary btn-compact" type="button" onclick="bacShowPage('my-tasks')">View All Tasks</button>
          </div>
