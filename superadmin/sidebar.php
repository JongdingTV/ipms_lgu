  <aside class="sidebar superadmin-sidebar" id="sidebar">
    <div class="sidebar-logo">
      ...
      <div class="logo-text">
        ...
        <span class="logo-sub">Super Admin Portal</span>
      </div>
    </div>
    ...
    <nav class="sidebar-nav">
      ...
      <a href="#" class="nav-item" data-page="user-governance">
        ...
        <span class="nav-label">User &amp; Role Governance</span>
        <span class="nav-badge" data-badge="user-governance"></span>
      </a>
      ...
      <a href="#" class="nav-item" data-page="login-security">
        <span class="nav-icon"><svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"/></svg></span>
        <span class="nav-label">Login Security</span>
        <span class="nav-badge" data-badge="login-security"></span>
      </a>
      <a href="#" class="nav-item" data-page="system-health">
