    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <a href="#" class="nav-item" data-page="award-approvals">
          ...
          <span class="nav-badge" data-badge="award-approvals"></span>
        </a>
        <a href="#" class="nav-item" data-page="returned-projects">
          ...
          <span class="nav-label">Returned Projects</span>
          <span class="nav-badge" data-badge="returned-projects"></span>
        </a>
        <a href="#" class="nav-item" data-page="deletion-requests">
          <span class="nav-icon"><svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"/></svg></span>
          <span class="nav-label">Deletion Requests</span>
          <span class="nav-badge" data-badge="deletion-requests"></span>
        </a>
        <a href="#" class="nav-item" data-page="edit-requests">
          <span class="nav-icon"><svg viewBox="0 0 20 20" fill="currentColor"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793z"/><path d="M11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/></svg></span>
          <span class="nav-label">Edit Requests</span>
          <span class="nav-badge" data-badge="edit-requests"></span>
        </a>
        <a href="#" class="nav-item" data-page="decision-history">
          ...
          <span class="nav-label">Decision History</span>
        </a>
      </div>
      ...
      <div class="nav-group">
        ...
        <a href="#" class="nav-item" data-page="approved-projects">
          ...
          <span class="nav-label">Approved Projects</span>
        </a>
        <a href="#" class="nav-item" data-page="ongoing-projects">
          ...
          <span class="nav-label">Ongoing Projects</span>
        </a>
      ...
      <div class="nav-group">
        ...
        <a href="#" class="nav-item" data-page="budget-summary">
          ...
          <span class="nav-label">Budget Summary</span>
        </a>
