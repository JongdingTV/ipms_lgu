 ...
 * Registration creates citizens as status 'inactive' until they verify the
 * OTP (see citizen/register.php), so "inactive + never logged in" identifies
 * abandoned signups; last_login IS NULL protects accounts an admin merely
 * deactivated later. Non-citizen roles are never touched.
 */
